...
cms_energy_config = import_from(f"Config/Parameters{reco_args.cmsEnergy}GeV.cfg")
...
BgOverlayWW.Parameters = {
    ...
    "expBG": [cms_energy_config.PARAMETERS["ExpectedBgWW"]],
}
...
BgOverlayWB.Parameters = {
    "InputFileNames": ["undefined.slcio"],
    "NumberOverlayEvents": ["0"],
    "expBG": [cms_energy_config.PARAMETERS["ExpectedBgWB"]],
}
...
BgOverlayBW.Parameters = {
    "InputFileNames": ["undefined.slcio"],
    "NumberOverlayEvents": ["0"],
    "expBG": [cms_energy_config.PARAMETERS["ExpectedBgBW"]],
}
...
BgOverlayBB.Parameters = {
    "InputFileNames": ["undefined.slcio"],
    "NumberOverlayEvents": ["0"],
    "expBG": [cms_energy_config.PARAMETERS["ExpectedBgBB"]],
}
...
VertexFinder.Parameters = {
    ...
    "BeamSizeX": [cms_energy_config.PARAMETERS["BeamSizeX"]],
    "BeamSizeY": [cms_energy_config.PARAMETERS["BeamSizeY"]],
    "BeamSizeZ": [cms_energy_config.PARAMETERS["BeamSizeZ"]],
    ...
    "PrimaryVertexFinder.BeamspotConstraint": [
        cms_energy_config.PARAMETERS["LCFIPlusBeamspotConstraint"]
    ],
